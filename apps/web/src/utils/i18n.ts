...
export const TRANSLATIONS: Record<LanguageId, Record<string, string>> = {
  English: {
    ...
    good_evening_title: 'Good evening',
    ...
    increase_sip_recommendation: 'Increase your Nifty 50 Index SIP by ₹2,500.',
    apply_recommendation: 'Apply Recommendation',
    why: 'Why?',
    goal_progress: 'Goal Progress',
    manage_goals: 'Manage Goals',
    no_active_goals: 'No active goals yet',
    no_active_goals_desc: 'Create a goal to start tracking and optimizing your progress.',
    ...
    projected_end_balance: 'Projected End Balance',
    cash_flow: 'Cash Flow',
    total_income: 'Total Income',
    needs_housing: 'Needs & Housing',
    wants_leisure: 'Wants & Leisure',
    savings_sips: 'Savings & SIPs',
  ...
  Hindi: {
    ...
    todays_recommendation: 'आज का एआई सुझाव',
    increase_sip_recommendation: 'निफ्टी 50 इंडेक्स एसआईपी में ₹2,500 की बढ़ोतरी करें।',
    apply_recommendation: 'सुझाव लागू करें',
    why: 'कारण जानें',
    goal_progress: 'लक्ष्य प्रगति',
    manage_goals: 'लक्ष्य प्रबंधन',
    no_active_goals: 'कोई सक्रिय लक्ष्य नहीं',
    no_active_goals_desc: 'अपनी बचत और प्रगति को ट्रैक करने के लिए पहला लक्ष्य बनाएं।',
    create_first_goal: 'पहला लक्ष्य बनाएं',
    budget_health: 'बजट स्वास्थ्य',
    review_budget: 'बजट समीक्षा',
    monthly_remaining: 'मासिक शेष राशि',
    projected_end_balance: 'अनुमानित अंतिम शेष',
    cash_flow: 'कैश फ्लो',
    total_income: 'कुल आय',
    needs_housing: 'आवश्यकताएं और आवास',
    wants_leisure: 'इच्छाएं और मनोरंजन',
    savings_sips: 'बचत और एसआईपी',
