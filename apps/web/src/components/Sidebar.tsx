  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex flex-col w-64 border-r border-slate-800 bg-slate-950/80 backdrop-blur-xl h-screen sticky top-0 z-30 p-4">
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                  isActive
                    ? 'bg-gradient-to-r from-emerald-500/15 to-emerald-500/5 text-emerald-400 border border-emerald-500/20 shadow-sm'
        ...
        <div className="mt-auto p-4 rounded-2xl glass-card border border-emerald-500/20 bg-gradient-to-br from-emerald-950/40 via-slate-900 to-slate-950">
          ...
          <button
            ...
            className="w-full py-2 px-3 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs rounded-xl shadow-lg shadow-emerald-500/20 transition-all cursor-pointer"
          >
            Launch Advisor
          </button>
        </div>
